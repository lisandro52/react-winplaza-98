 ...
 */
const Checkbox = reactExports.forwardRef(({ name, label, ...inputProps }, ref) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("input", { type: "checkbox", name: name, id: name, ...inputProps, ref: ref }),
 ...
 * ```
 */
const Dropdown = reactExports.forwardRef(({ name, label, children, ...selectProps }, ref) => {
    return (React.createElement("select", { ref: ref, name: name, ...selectProps }, children));
});
...
const useOptionContext = () => {
    ...
    if (context === undefined) {
        throw new Error('The OptionButton compound components cannot be rendered outside the OptionGroup component');
    }
    return context;
};
...
const OptionGroup = (props) => {
    return (React.createElement(OptionContext.Provider, { value: props }, props.children));
};
 ...
 */
const OptionButton = reactExports.forwardRef(({ label, ...inputProps }, ref) => {
    ...
    return (React.createElement("div", { className: "field-row" },
        React.createElement("input", { id: inputId, type: "radio", name: name, ...inputProps, ref: ref, defaultChecked: defaultValue ? defaultValue === inputProps.value : undefined, checked: value ? value === inputProps.value : undefined, onChange: (e) => onChange?.(e.target.value) }),
        React.createElement("label", { htmlFor: inputId }, label)));
});

const Slider = reactExports.forwardRef(({ name, label, minLabel, maxLabel, min, max, className, boxIndicator = false, vertical = false, onChange, ...inputProps }, ref) => {
    const inputId = reactExports.useId();
    return (React.createElement("div", { className: "field-row" },
        React.createElement("label", { htmlFor: `${inputId}-label` }, label),
        minLabel && React.createElement("label", { htmlFor: inputId }, minLabel),
        React.createElement("div", { className: clsx(vertical && 'is-vertical') },
            React.createElement("input", { ...inputProps, ref: ref, onChange: (event) => {
                    onChange?.(event, Number(event.target.value));
                }, className: clsx(className, {
                    'has-box-indicator': boxIndicator,
                }), id: inputId, name: name, type: "range", min: min, max: max })),
        maxLabel && React.createElement("label", { htmlFor: `${inputId}-high` }, maxLabel)));
});

const TextArea = reactExports.forwardRef(({ name, label, labelPosition = 'top', className, ...inputProps }, ref) => {
    const inputId = reactExports.useId();
    return (React.createElement("div", { className: clsx(className, {
        ...
        React.createElement("label", { htmlFor: inputId }, label),
        React.createElement("textarea", { ref: ref, id: inputId, name: name, ...inputProps })));
});

const TextBox = reactExports.forwardRef(({ type = 'text', name, label, labelPosition = 'left', className, ...inputProps }, ref) => {
    const inputId = reactExports.useId();
    return (React.createElement("div", { className: clsx(className, {
            'field-row': labelPosition === 'left',
            'field-row-stacked': labelPosition === 'top',
        ...
        React.createElement("label", { htmlFor: inputId }, label),
        React.createElement("input", { id: inputId, name: name, type: type, ...inputProps })));
});
